...
func (p *BSVParser) GetAddrDescFromAddress(address string) (bchain.AddressDescriptor, error) {
	return p.addressToOutputScript(address)
}

// addressToOutputScript converts bitcoin address to ScriptPubKey
func (p *BSVParser) addressToOutputScript(address string) ([]byte, error) {
...
func (p *BSVParser) outputScriptToAddresses(script []byte) ([]string, bool, error) {
